...
‏واختُتم اليوم بتكريم الفريقين الفائزين بالمركزين الأول والثاني بمكافآت مالية، إضافةً إلى توزيع هدايا وكوبونات على جميع المشاركين، وسط أجواء من الفخر والإنجاز والروح الإيجابية.`,
  ...
  },
  {
    ...
    fullDescription: `تحدي الثلاثين – منافسة المعرفة والإبداع\n
    \nفي يوم السبت الموافق 16 آب 2025، نظّمت الشبكة العربية للابتكار (عين) فعالية "تحدي الثلاثين" تحت إشراف ومتابعة حديقة النجاح للابتكار وعمادة شؤون الطلبة في مدرج القانون – الحرم الجديد بجامعة النجاح الوطنية، من الساعة 9 صباحاً حتى 5 مساءً.\n
    \nشهدت الفعالية مشاركة ما يقارب 130–140 طالباً توزّعوا على 30 فريقاً، بالإضافة إلى فريق مشارك من غزة عبر الاتصال المرئي، تنافسوا فيما بينهم بروحٍ عالية من الحماس والمعرفة للوصول إلى لقب الفريق البطل. وتضمّن التحدي أربع فقرات متتالية (الجرس، المزاد، المستحيل، وماذا تعرف)، اختبرت ثقافة المشاركين في مجالات الدين، والتاريخ، والجغرافيا، والرياضة.
    \n
    \nفريق التنظيم والإدارة\n
    \nقام على تنظيم وإنجاح هذا الحدث الضخم طاقم إداري وتقني متميز من أعضء الهيئة الإدارية للشبكة، وهم:\n
    \n
    محمد سويلم (رئيس الشبكة)
    \nمحمد دراغمة (نائب الرئيس)
    \nمصعب حداد (منسق الأنشطة)
    \nحمزة عبد السلام (مسؤول شؤون الأعضاء)
    \nسديل دراغمة (مسؤولة العلاقات العامة)
    \nنجوى خزندار (مسؤولة المالية)
    \nأسماء عبد الهادي (مسؤولة الإعلام الرقمي)
    \nغيداء رمضان وتالا هندي (مسؤولتا الحلول التقنية)
    \nميرا سردي (محررة الفيديوهات)
    \nطيبة دويكات (مصممة الشبكة)
    \nوشادي سلعوس (مصور الشبكة)
    \n
    \nالحضور الرسمي والختام
    \n
    \nوقد حضر الفعالية عدد من الشخصيات البارزة في الجامعة، من بينهم:
    \n• الدكتور علام موسى – مدير حديقة النجاح للابتكار.
    \n• الأستاذ باسم غيث – مشرف الشبكة العربية للابتكار.
    \n• الأستاذة لمياء عناب – منسقة الشبكة العربية للابتكار الأم.
    \n• الأستاذ إياد الأقرع – مدير شؤون الطلبة.
    \n• الأستاذ عنان ناصر – منسق الجمعيات في الجامعة
    \n
    \nجاء تنظيم هذا التحدي بهدف نشر الوعي وروح المنافسة الإيجابية، وفي الختام تم تقديم جوائز قيّمة للفريق الفائز بالمركز الأول، إلى جانب توزيع هدايا تذكارية على جميع المشاركين تقديرًا لجهودهم ومشاركتهم الفاعلة.`,
